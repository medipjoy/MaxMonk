...
export function ActiveScreen({ tokens, fontChoice }: Props) {
  ...
  const s = StyleSheet.create({
    ...
    sectionLabel: { fontFamily: 'Inter_500Medium', fontSize: fontScale(7.5, fontSizeMultiplier), color: tokens.textGhost, textTransform: 'uppercase', letterSpacing: 0.1 * fontScale(7.5, fontSizeMultiplier) },
